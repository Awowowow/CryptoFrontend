  ...
  if (isVerified) {
    return (
      <div className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
        <Card className="flex min-h-96 flex-col justify-center">
          <div className="grid size-14 place-items-center rounded-2xl bg-emerald-50 text-emerald-600">
            <CheckCircle2 size={30} />
          </div>
          <span className="mt-6 inline-flex w-fit rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700">
            Email verified
          </span>
          ...
          <p className="mt-3 text-sm leading-6 text-slate-500">
            Email verification is complete. Redirecting you to sign in now.
          </p>
          <Link
            className="mt-7 inline-flex w-fit items-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700"
            to="/auth/login"
          >
            Go to login
            <ArrowRight size={16} />
